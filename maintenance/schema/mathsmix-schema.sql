...
--
-- Host: localhost
-- Generation Time: Oct 05, 2012 at 04:43 PM
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Area of a country with a common curriculum' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `domain` (
  ...
  KEY `school_id` (`school_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Domain names which are in use' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `school` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Schools' AUTO_INCREMENT=1 ;
