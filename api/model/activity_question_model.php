...
class activity_question_model {
	...
	*/
	...
	public function populate_list_activity_question_response() {
		$this -> list_activity_question_response = activity_question_response_model::list_by_aq_id($this -> aq_id);
	}
